...
public class ForestFireCell : MonoBehaviour
{
    ...
    public Material groundMaterialphoneBooth; 
    ...
    public GameObject PhoneBoothObject; // reference to rock visual object
    ...
    private void ResetCell()
    {
        ...
        PhoneBoothObject.SetActive(false);
    ...
    public void SetPhoneBooth()
    {
        ...
        // this code below wont run once the rock material has been set
        ResetCell();
        cellState = State.PhoneBooth;
        PhoneBoothObject.SetActive(true);
        cellFuel = 1000;
        groundMeshRenderer.material = groundMaterialRock; // sets the cell material to rock
